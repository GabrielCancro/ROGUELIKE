...
func selectButton(btn):
	...
	elif btn=="btn4": light_size=Vector2(250,100)
...
func get_input():
	...
	if Input.is_action_just_pressed('ui_accept'): 
		if buttonSelect=='btn1': 
			...
			get_node("/root/Node2D").goto_scene("res://Game/main.tscn",get_node('/root/Node2D/Buttons/btn1') )
		elif buttonSelect=='btn3': get_tree().quit()
		elif buttonSelect=='btn2': OS.window_fullscreen = !OS.window_fullscreen
